...
def learning():
    ...
    if len(drawn_strokes) and text_learned:
        ...
        messagebox.showwarning("Empty Input", "Please enter some text before submitting.")
...
for name in set(models):
    button = tk.Button(side_panel, text=name, command=lambda n=name: create_canvas_with_strokes(n))
